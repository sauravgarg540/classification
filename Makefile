...
PYTEST_ARGS = --show-capture no --full-trace --verbose --cov api/ --cov-report term-missing --cov-report html
...
SRC_CODE = experiments/ tools/ lib/ utils/ tests/
...
## Run the blacken pydocstyle
blacken-docs:
	blacken-docs $(SRC_CODE)
