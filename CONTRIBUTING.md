# Contributing to TorchDL/Classification

Thanks for your interest in contributing to TorchDL. We're grateful for your initiative! ❤️
...
* **Environment:** You can find this with ``pip freeze``
...
1. Create a [new branch](#naming-your-branch), for example `fix-model-typo-1`.
...
* `issue_id` is [the GitHub issue](https://github.com/TorchDL/classification/issues) number. Having the correct issue number will automatically link the Pull Request on this branch to that issue.
...
A good commit message helps us track the development. A Pull Request with a bad commit message will be *rejected* automatically in the CI pipeline.
...
Once again, thanks so much for your interest in contributing to our library. We're excited to see your contributions!